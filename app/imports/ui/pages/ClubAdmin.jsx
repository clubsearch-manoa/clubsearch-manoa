...
const EditStuff = () => {
  ...
  const submit = (data) => {
    const { name, image, description, meetingTimes, tags } = data;
    Clubs.collection.update(_id, { $set: { name, image, description, meetingTimes, tags } }, (error) => (error ?
